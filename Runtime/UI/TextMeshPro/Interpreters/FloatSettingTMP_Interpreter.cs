...
{
    public class FloatSettingTMP_Interpreter : FloatSettingInterpreter, ISettingTMP_InputFieldInterpreter
    {
        ...
        {
            tmp_InputField.contentType = TMP_InputField.ContentType.DecimalNumber;
        }
